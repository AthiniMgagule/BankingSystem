...
public class DataManager {
    ...
    public static HashMap<String, BankAccount> loadAccounts() {
        ...
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream(ACCOUNTS_FILE))) {
            ...
            for (String id : accounts.keySet()) {
                ...
                System.out.println("  - Account #" + acc.getAccountNo() + " (Customer: " + acc.getCustomerID() + ", Balance: $" + acc.getBalance() + ")");
            }
    ...
    // Simple load method - don't modify passed collections, just return data
